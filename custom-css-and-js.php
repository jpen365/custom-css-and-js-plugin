...
Plugin URI:    http://premium.wpmudev.org/blog/author/jonpenland
...
function custom_css_js_enqueue_scripts() {
    ...
    wp_enqueue_style( 'custom-css', plugins_url( '/css/custom-style.css', __FILE__ ), $ver = false, $in_footer = true );
